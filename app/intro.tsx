...
const baseStyles = StyleSheet.create({
  ...
  artShade: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(8,10,12,0.12)" },
  ...
  artBadge: { position: "absolute", left: 18, bottom: 18, backgroundColor: colors.cream, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 7 },
  artBadgeText: { color: colors.ink, fontSize: 9, fontWeight: "900", letterSpacing: 1 },
  cta: {
    marginTop: 16,
