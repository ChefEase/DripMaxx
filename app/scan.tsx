              ...
              {evolution ? (
                <View style={styles.evolutionCard}>
                  ...
                  <View style={styles.evolutionScoreRow}>
                    ...
                    <Text style={styles.evolutionArrow}>→</Text>
                    <View style={styles.evolutionScoreCell}><Text style={[styles.evolutionScoreValue, { color: "#FEFEFE" }]}>{evolution.potential_score.toFixed(1)}</Text><Text style={styles.evolutionScoreLabel}>Potential</Text></View>
                  </View>
...
const baseStyles = StyleSheet.create({
  ...
  continueJourneyEyebrow: { color: "#FEFEFE", fontSize: 10, fontWeight: "900", letterSpacing: 1 },
  continueJourneyTitle: { color: "#FEFEFE", fontSize: 16, fontWeight: "900" },
  continueJourneyText: { color: "rgba(255,255,255,0.82)", fontSize: 12, lineHeight: 17 },
  continueJourneyArrow: { color: "#FEFEFE", fontSize: 30, fontWeight: "500" },
  previewImage: {
    width: "100%",
    aspectRatio: 3 / 4,
    borderRadius: 12,
  ...
  evolutionModeTitle: { color: "#FEFEFE", fontSize: 14, fontWeight: "900" },
  evolutionModeText: { color: "rgba(255,255,255,0.84)", fontSize: 13, lineHeight: 18 },
  ...
  leaveEvolutionText: { color: "#FEFEFE", fontSize: 12, fontWeight: "900" },
  ...
  savedPlanEyebrow: { color: "#FEFEFE", fontSize: 10, fontWeight: "900", letterSpacing: 1 },
  savedPlanTitle: { color: "#FEFEFE", fontSize: 19, fontWeight: "900", marginTop: 3 },
  savedPlanPotential: { color: "#FEFEFE", fontSize: 31, fontWeight: "900" },
  savedPlanOutOf: { color: "rgba(255,255,255,0.82)", fontSize: 13, fontWeight: "800" },
  savedPlanProgress: { color: "rgba(255,255,255,0.88)", fontSize: 13, fontWeight: "800" },
  ...
  savedTargetBadgeText: { color: "#FEFEFE", fontSize: 10, fontWeight: "900", letterSpacing: 1 },
  ...
  savedPlanSectionTitle: { color: "#FEFEFE", fontSize: 15, fontWeight: "900" },
  ...
  savedPlanItemTitle: { color: "#FEFEFE", fontSize: 14, fontWeight: "900", flex: 1 },
  savedPlanItemText: { color: "rgba(255,255,255,0.78)", fontSize: 13, lineHeight: 18 },
  savedPlanPartial: { color: "#FDE68A", fontSize: 11, lineHeight: 16 },
  savedPlanRegressed: { color: "#FED7AA", fontSize: 11, lineHeight: 16 },
  savedPlanNote: { color: "rgba(255,255,255,0.84)", fontSize: 12, lineHeight: 17, textAlign: "center" },
  ...
  evolutionEyebrow: { color: "#FEFEFE", fontSize: 12, fontWeight: "900", letterSpacing: 1, textAlign: "center" },
  evolutionTitle: { color: "#FEFEFE", fontSize: 19, fontWeight: "900", marginTop: 3 },
  ...
  evolutionScoreValue: { color: "#FEFEFE", fontSize: 24, fontWeight: "900" },
  evolutionScoreLabel: { color: "rgba(255,255,255,0.68)", fontSize: 11, fontWeight: "800", textTransform: "uppercase" },
  ...
  evolutionSummary: { color: "rgba(255,255,255,0.78)", fontSize: 13, lineHeight: 19, textAlign: "center" },
  ...
  revisionHistoryLabel: { color: "rgba(255,255,255,0.78)", fontSize: 12, fontWeight: "700" },
  revisionHistoryScore: { color: "#FEFEFE", fontSize: 12, fontWeight: "900" },
  deltaPositive: { color: "#FEFEFE", fontSize: 20, fontWeight: "900" },
  ...
  upgradeTitle: { color: "#FEFEFE", fontSize: 14, fontWeight: "900", flex: 1 },
  upgradeText: { color: "rgba(255,255,255,0.78)", fontSize: 13, lineHeight: 18 },
  upgradeEvidence: { color: "#A7F3D0", fontSize: 11, lineHeight: 16, fontStyle: "italic" },
  importanceTag: { color: "rgba(255,255,255,0.78)", fontSize: 10, fontWeight: "900", textTransform: "uppercase" },
  ...
  targetRetryText: { color: "#FEFEFE", fontSize: 13, fontWeight: "900", marginTop: 5 },
  ...
  targetNumber: { color: "#FEFEFE", fontSize: 16, fontWeight: "900" },
  ...
  revealNewScore: { color: "#FEFEFE", fontSize: 48, fontWeight: "900" },
  revealComplete: { color: "#FEFEFE", fontSize: 16, fontWeight: "900" },
  scoreMeterTop: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
