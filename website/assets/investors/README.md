# DripMaxx investor-page assets

Place investor media in this directory using these names:

- founder.jpg — founder portrait
- product-dashboard.png — home/dashboard screen
...
Crop sensitive account details from screenshots. Only use names, quotes, handles,
and portraits when DripMaxx has permission to publish them.
